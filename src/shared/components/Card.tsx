...
const baseStyles = (padding: number, hoverable: boolean, glow: boolean, noPadding: boolean) => css({
	position: 'relative',
...
export function Card({ children, padding = 6, noPadding = false, onClick, hoverable = false, glow = false }: CardProps) {
	return (
